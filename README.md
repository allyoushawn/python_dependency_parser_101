This is a python implementation of a simple dependency parser. The code is almost the same with the one on https://gist.github.com/syllog1sm/10343947 with some additoinal comments on it.
